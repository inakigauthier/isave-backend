...
crypto = Investment.create!(isin: 'FR0000000004', investment_types: 'Crypto', label: 'Bitcoin', price: 30_000, sri: 7)
...
# Balanced Portfolio
PortfolioInvestment.create!(portfolio: balanced_portfolio, investment: bond, amount_invested: 20_000)
PortfolioInvestment.create!(portfolio: balanced_portfolio, investment: etf, amount_invested: 30_000)
PortfolioInvestment.create!(portfolio: balanced_portfolio, investment: stock, amount_invested: 20_000)

# Aggressive Portfolio
PortfolioInvestment.create!(portfolio: aggressive_portfolio, investment: stock, amount_invested: 40_000)
PortfolioInvestment.create!(portfolio: aggressive_portfolio, investment: crypto, amount_invested: 50_000)
