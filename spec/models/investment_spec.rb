...
RSpec.describe Investment, type: :model do
  ...
  describe "associations" do
    it "can be linked to many portfolios through portfolio investments" do
      ...
      portfolio1 = customer.portfolios.create!(label: "Balanced", portfolio_type: "Balanced", total_amount: 50000)
      portfolio2 = customer.portfolios.create!(label: "Risky", portfolio_type: "Risky", total_amount: 80000)

      PortfolioInvestment.create!(portfolio: portfolio1, investment: investment, amount_invested: 10000)
      PortfolioInvestment.create!(portfolio: portfolio2, investment: investment, amount_invested: 20000)
